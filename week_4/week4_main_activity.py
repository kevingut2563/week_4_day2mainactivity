...
print(result[0:4]) #prints the first four letters
print(result[-1])#prints the last letter of the text 
# this is called indexing 
#index slicing is a way to get a substring from a string from a string 
#substrings are a squcence of characters from a string 
...
#-1 means something is the end of a text or dosen't exist 
...
extract2 = "Never trust a computer you can't throw out a window"
